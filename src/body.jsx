...
export default function Body(){
    ...
    return(
        <div  >
            <ImageSlider  />
            <div  className="back-color  lg:my-[10vh] my-[20vh] ">
...
" />        <span id="photos" ></span>
                <SlideFromRight id="4" image="src/assets/pic-4.jpg" title="ساخت" text="فعالیت در زمینه ساخت کلیه قالبهای صنعتی تزریق پلاستیک Injection Molding قالب بادی Blow Molding قالب دایکست Diecasting و بومی سازی قطعات صنعتی." />
